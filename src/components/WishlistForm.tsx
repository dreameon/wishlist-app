...
import { Wish, Product, Variant, VariantChosen } from "@/utils/types";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { useFormStatus } from "react-dom";
import { fetchProduct, postWish, fetchWishlist } from "@/utils/queries";
...
export default function WishlistForm({
  ...
  return (
    <div className="flex gap-[48px] p-[48px] rounded-[16px] border border-[#D8D8D8]">
      <img
